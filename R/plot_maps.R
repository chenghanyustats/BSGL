...
require_ggspatial <- function() {
  if (!requireNamespace("ggspatial", quietly = TRUE)) {
    stop("Package 'ggspatial' is required for map scale bars and north arrows.", call. = FALSE)
  }
}

# ===========================================
# Plot observed EVI map
# ===========================================

plot_observed_evi <- function(data, ocean_crop, coast_crop, lakes_crop, rivers_crop, 
                              save_path = "pic/observed_evi.png") {
  require_ggspatial()
...
plot_coefficient_maps <- function(lasso_gam, train_coords, sample_real_data,
                                  ...
                                  n_grid = 80,
                                  save_path = "pic/coefficient_maps.png") {
